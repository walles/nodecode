...
class BsdfHairPrincipled:
    ...
    def __init__(
        ...
        Absorption_Coefficient: Tuple[float, float, float] = ...,
        Aspect_Ratio: float = ...,
        Roughness: float = ...,
...
class BsdfMetallic:
    ...
    def __init__(
        ...
        Edge_Tint: Tuple[float, float, float, float] = ...,
        IOR: Tuple[float, float, float] = ...,
...
class BsdfPrincipled:
    ...
    def __init__(
        ...
        Specular_Tint: Tuple[float, float, float, float] = ...,
        Anisotropic: float = ...,
        ...
        Coat_IOR: float = ...,
        Coat_Tint: Tuple[float, float, float, float] = ...,
        Coat_Normal: Tuple[float, float, float] = ...,
        Sheen_Weight: float = ...,
        Sheen_Roughness: float = ...,
        Sheen_Tint: Tuple[float, float, float, float] = ...,
...
class BsdfTransparent:
    ...
    def __init__(
        self, Color: Tuple[float, float, float, float] = ..., Weight: float = ...
    ) -> None: ...
    def BSDF(self) -> Any:
        """BSDF"""
...
class CameraData:
    ...
    def View_Vector(self) -> Tuple[float, float, float]:
        """View Vector"""
    def View_Z_Depth(self) -> float:
        """View Z Depth"""
...
class Clamp:
    ...
    def __init__(
        self, clamp_type: Any, Value: float = ..., Min: float = ..., Max: float = ...
    ) -> None: ...
...
class CombineColor:
    ...
    def __init__(
        self, mode: Any, Red: float = ..., Green: float = ..., Blue: float = ...
    ) -> None: ...
    def Color(self) -> Tuple[float, float, float, float]:
        """Color"""
...
class EeveeSpecular:
    ...
    def __init__(
        ...
        Clear_Coat_Normal: Tuple[float, float, float] = ...,
        Weight: float = ...,
    ) -> None: ...
    def BSDF(self) -> Any:
        """BSDF"""
...
class Fresnel:
    ...
    def __init__(
        self, IOR: float = ..., Normal: Tuple[float, float, float] = ...
    ) -> None: ...
    def Fac(self) -> float:
        """Fac"""
...
class Gamma:
    ...
    def __init__(
        self, Color: Tuple[float, float, float, float] = ..., Gamma: float = ...
    ) -> None: ...
    def Color(self) -> Tuple[float, float, float, float]:
        """Color"""
...
class HairInfo:
    ...
    def Thickness(self) -> float:
        """Thickness"""
    def Tangent_Normal(self) -> Tuple[float, float, float]:
        """Tangent Normal"""
...
class Invert:
    ...
    def __init__(
        self, Fac: float = ..., Color: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Color(self) -> Tuple[float, float, float, float]:
        """Color"""
...
class LayerWeight:
    ...
    def __init__(
        self, Blend: float = ..., Normal: Tuple[float, float, float] = ...
    ) -> None: ...
    def Fresnel(self) -> float:
        """Fresnel"""
...
class LightPath:
    ...
    def Is_Camera_Ray(self) -> float:
        """Is Camera Ray"""
    def Is_Shadow_Ray(self) -> float:
        """Is Shadow Ray"""
    def Is_Diffuse_Ray(self) -> float:
        """Is Diffuse Ray"""
    def Is_Glossy_Ray(self) -> float:
        """Is Glossy Ray"""
    def Is_Singular_Ray(self) -> float:
        """Is Singular Ray"""
    def Is_Reflection_Ray(self) -> float:
        """Is Reflection Ray"""
    def Is_Transmission_Ray(self) -> float:
        """Is Transmission Ray"""
    def Ray_Length(self) -> float:
        """Ray Length"""
    def Ray_Depth(self) -> float:
        """Ray Depth"""
    def Diffuse_Depth(self) -> float:
        """Diffuse Depth"""
    def Glossy_Depth(self) -> float:
        """Glossy Depth"""
    def Transparent_Depth(self) -> float:
        """Transparent Depth"""
    def Transmission_Depth(self) -> float:
        """Transmission Depth"""
...
class MapRange:
    ...
    def __init__(
        ...
        From_Min2: Tuple[float, float, float] = ...,
        From_Max2: Tuple[float, float, float] = ...,
        To_Min2: Tuple[float, float, float] = ...,
        To_Max2: Tuple[float, float, float] = ...,
        Steps2: Tuple[float, float, float] = ...,
    ) -> None: ...
    def Result(self) -> float:
        """Result"""
    def Vector(self) -> Tuple[float, float, float]:
...
class Mix:
    ...
    def __init__(
        ...
        clamp_result: bool,
        Factor1: float = ...,
        Factor2: Tuple[float, float, float] = ...,
        A1: float = ...,
        B1: float = ...,
    ...
    def Result1(self) -> float:
        """Result"""
    def Result2(self) -> Tuple[float, float, float]:
        """Result"""
    def Result3(self) -> Tuple[float, float, float, float]:
        """Result"""
    def Result4(self) -> Any:
        """Result"""
...
class MixShader:
    ...
    def __init__(
        self, Fac: float = ..., Shader1: Any = ..., Shader2: Any = ...
    ) -> None: ...
    def Shader(self) -> Any:
        """Shader"""
...
class NewGeometry:
    ...
    def Tangent(self) -> Tuple[float, float, float]:
        """Tangent"""
    def True_Normal(self) -> Tuple[float, float, float]:
        """True Normal"""
    def Incoming(self) -> Tuple[float, float, float]:
        """Incoming"""
    def Parametric(self) -> Tuple[float, float, float]:
        """Parametric"""
    def Backfacing(self) -> float:
        """Backfacing"""
    def Pointiness(self) -> float:
        """Pointiness"""
    def Random_Per_Island(self) -> float:
        """Random Per Island"""
...
class ObjectInfo:
    ...
    def Alpha(self) -> float:
        """Alpha"""
    def Object_Index(self) -> float:
        """Object Index"""
    def Material_Index(self) -> float:
        """Material Index"""
    def Random(self) -> float:
        """Random"""
...
class OutputLight:
    ...
    def __init__(
        self, is_active_output: bool, target: Any, Surface: Any = ...
    ) -> None: ...
...
class OutputWorld:
    ...
    def __init__(
        self, is_active_output: bool, target: Any, Surface: Any = ..., Volume: Any = ...
    ) -> None: ...
...
class SeparateColor:
    ...
    def __init__(
        self, mode: Any, Color: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Red(self) -> float:
        """Red"""
...
class Squeeze:
    """Deprecated"""
    def __init__(
        self, Value: float = ..., Width: float = ..., Center: float = ...
    ) -> None: ...
    def Value(self) -> float:
        """Value"""
...
class TexCoord:
    ...
    def Generated(self) -> Tuple[float, float, float]:
        """Generated"""
    def Normal(self) -> Tuple[float, float, float]:
        """Normal"""
    def UV(self) -> Tuple[float, float, float]:
        """UV"""
    def Object(self) -> Tuple[float, float, float]:
        """Object"""
    def Camera(self) -> Tuple[float, float, float]:
        """Camera"""
    def Window(self) -> Tuple[float, float, float]:
        """Window"""
    def Reflection(self) -> Tuple[float, float, float]:
        """Reflection"""
...
class TexGabor:
    ...
    def __init__(
        ...
        Anisotropy: float = ...,
        Orientation1: float = ...,
        Orientation2: Tuple[float, float, float] = ...,
    ) -> None: ...
    def Value(self) -> float:
        """Value"""
...
class TexGradient:
    ...
    def __init__(
        self, gradient_type: Any, Vector: Tuple[float, float, float] = ...
    ) -> None: ...
    def Color(self) -> Tuple[float, float, float, float]:
        """Color"""
    def Fac(self) -> float:
...
class TexPointDensity:
    ...
    def __init__(
        ...
        space: Any,
        interpolation: Any,
        particle_color_source: Any,
        vertex_color_source: Any,
...
class VectorCurve:
    ...
    def __init__(
        self, Fac: float = ..., Vector: Tuple[float, float, float] = ...
    ) -> None: ...
    def Vector(self) -> Tuple[float, float, float]:
        """Vector"""
...
class VolumePrincipled:
    ...
    def __init__(
        ...
        Anisotropy: float = ...,
        Absorption_Color: Tuple[float, float, float, float] = ...,
        Emission_Strength: float = ...,
        Emission_Color: Tuple[float, float, float, float] = ...,
        Blackbody_Intensity: float = ...,
        Blackbody_Tint: Tuple[float, float, float, float] = ...,
        Temperature: float = ...,
