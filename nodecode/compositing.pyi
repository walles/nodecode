...
class AlphaOver:
    ...
    def __init__(
        ...
        premul: Any,
        Fac: float = ...,
        Image1: Tuple[float, float, float, float] = ...,
        Image2: Tuple[float, float, float, float] = ...,
    ) -> None: ...
...
class Bilateralblur:
    ...
    def __init__(
        ...
        sigma_space: Any,
        Image: Tuple[float, float, float, float] = ...,
        Determinator: Tuple[float, float, float, float] = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class BokehBlur:
    ...
    def __init__(
        ...
        blur_max: Any,
        Image: Tuple[float, float, float, float] = ...,
        Bokeh: Tuple[float, float, float, float] = ...,
        Size: float = ...,
        Bounding_box: float = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
...
class BokehImage:
    ...
    def __init__(
        self, angle: Any, flaps: int, rounding: Any, catadioptric: Any, shift: Any
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class ChromaMatte:
    ...
    def __init__(
        ...
        shadow_adjust: Any,
        Image: Tuple[float, float, float, float] = ...,
        Key_Color: Tuple[float, float, float, float] = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
    def Matte(self) -> float:
...
class ColorBalance:
    ...
    def __init__(
        ...
        slope: Any,
        offset_basis: Any,
        input_temperature: Any,
        input_tint: Any,
        input_whitepoint: Any,
        output_temperature: Any,
        output_tint: Any,
        output_whitepoint: Any,
        Fac: float = ...,
        Image: Tuple[float, float, float, float] = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
...
class ColorCorrection:
    ...
    def __init__(
        ...
        midtones_start: Any,
        midtones_end: Any,
        master_saturation: Any,
        master_contrast: Any,
        master_gamma: Any,
        master_gain: Any,
        master_lift: Any,
        shadows_saturation: Any,
        shadows_contrast: Any,
        shadows_gamma: Any,
        shadows_gain: Any,
        shadows_lift: Any,
        midtones_saturation: Any,
        midtones_contrast: Any,
        midtones_gamma: Any,
        midtones_gain: Any,
        midtones_lift: Any,
        highlights_saturation: Any,
        highlights_contrast: Any,
        highlights_gamma: Any,
        highlights_gain: Any,
        highlights_lift: Any,
        Image: Tuple[float, float, float, float] = ...,
        Mask: float = ...,
...
class CombYUVA:
    """Deprecated"""
    def __init__(
        self, Y: float = ..., U: float = ..., V: float = ..., A: float = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class Cryptomatte:
    ...
    def __init__(
        ...
        remove: Any,
        Image: Tuple[float, float, float, float] = ...,
        Crypto_00: Tuple[float, float, float, float] = ...,
        Crypto_01: Tuple[float, float, float, float] = ...,
        Crypto_02: Tuple[float, float, float, float] = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
    def Matte(self) -> float:
        """Matte"""
    def Pick(self) -> Tuple[float, float, float, float]:
        """Pick"""
...
class DiffMatte:
    ...
    def __init__(
        ...
        tolerance: Any,
        falloff: Any,
        Image_1: Tuple[float, float, float, float] = ...,
        Image_2: Tuple[float, float, float, float] = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
    def Matte(self) -> float:
...
class DilateErode:
    ...
    def __init__(
        self, mode: Any, distance: int, edge: Any, falloff: Any, Mask: float = ...
    ) -> None: ...
    def Mask(self) -> float:
        """Mask"""
...
class Exposure:
    ...
    def __init__(
        self, Image: Tuple[float, float, float, float] = ..., Exposure: float = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class Flip:
    ...
    def __init__(
        self, axis: Any, Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class Gamma:
    ...
    def __init__(
        self, Image: Tuple[float, float, float, float] = ..., Gamma: float = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class Glare:
    ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
    def Glare(self) -> Tuple[float, float, float, float]:
        """Glare"""
    def Highlights(self) -> Tuple[float, float, float, float]:
        """Highlights"""
...
class HueCorrect:
    ...
    def __init__(
        self, Fac: float = ..., Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class IDMask:
    ...
    def __init__(
        self, index: int, use_antialiasing: bool, ID_value: float = ...
    ) -> None: ...
...
class Inpaint:
    ...
    def __init__(
        self, distance: int, Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class Levels:
    ...
    def __init__(
        self, channel: Any, Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Mean(self) -> float:
        """Mean"""
...
class Pixelate:
    ...
    def __init__(
        self, pixel_size: int, Color: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Color(self) -> Tuple[float, float, float, float]:
        """Color"""
...
class Posterize:
    ...
    def __init__(
        self, Image: Tuple[float, float, float, float] = ..., Steps: float = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class PremulKey:
    ...
    def __init__(
        self, mapping: Any, Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
...
class RLayers:
    ...
    def Position(self) -> Tuple[float, float, float]:
        """Position"""
    def Deprecated1(self) -> Tuple[float, float, float, float]:
        """Deprecated"""
    def Deprecated2(self) -> Tuple[float, float, float, float]:
        """Deprecated"""
    def Shadow(self) -> Tuple[float, float, float, float]:
        """Shadow"""
    def AO(self) -> Tuple[float, float, float, float]:
        """AO"""
    def Deprecated3(self) -> Tuple[float, float, float, float]:
        """Deprecated"""
    def Deprecated4(self) -> Tuple[float, float, float, float]:
        """Deprecated"""
    def Deprecated5(self) -> Tuple[float, float, float, float]:
        """Deprecated"""
    def IndexOB(self) -> float:
        """IndexOB"""
    def IndexMA(self) -> float:
        """IndexMA"""
    def Mist(self) -> float:
        """Mist"""
    def Emit(self) -> Tuple[float, float, float, float]:
        """Emit"""
    def Env(self) -> Tuple[float, float, float, float]:
        """Env"""
    def DiffDir(self) -> Tuple[float, float, float, float]:
        """DiffDir"""
    def DiffInd(self) -> Tuple[float, float, float, float]:
        """DiffInd"""
    def DiffCol(self) -> Tuple[float, float, float, float]:
        """DiffCol"""
    def GlossDir(self) -> Tuple[float, float, float, float]:
        """GlossDir"""
    def GlossInd(self) -> Tuple[float, float, float, float]:
        """GlossInd"""
    def GlossCol(self) -> Tuple[float, float, float, float]:
        """GlossCol"""
    def TransDir(self) -> Tuple[float, float, float, float]:
        """TransDir"""
    def TransInd(self) -> Tuple[float, float, float, float]:
        """TransInd"""
    def TransCol(self) -> Tuple[float, float, float, float]:
        """TransCol"""
    def SubsurfaceDir(self) -> Tuple[float, float, float, float]:
        """SubsurfaceDir"""
    def SubsurfaceInd(self) -> Tuple[float, float, float, float]:
        """SubsurfaceInd"""
    def SubsurfaceCol(self) -> Tuple[float, float, float, float]:
        """SubsurfaceCol"""
...
class SepYCCA:
    """Deprecated"""
    def __init__(
        self, mode: Any, Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Y(self) -> float:
        """Y"""
    def Cb(self) -> float:
...
class SeparateColor:
    ...
    def __init__(
        self, mode: Any, ycc_mode: Any, Image: Tuple[float, float, float, float] = ...
    ) -> None: ...
    def Red(self) -> float:
        """Red"""
...
class Switch:
    ...
    def __init__(
        self,
        check: bool,
        Off: Tuple[float, float, float, float] = ...,
        On: Tuple[float, float, float, float] = ...,
    ) -> None: ...
    def Image(self) -> Tuple[float, float, float, float]:
        """Image"""
